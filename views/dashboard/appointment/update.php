    ...
    <div class="col-lg-8 offset-lg-2 col-12 pt-5">
        <form method="POST" id="formUser">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        <input type="date" name="appointment_date" id="appointment_date" class="form-control" value="<?= $data->appointment_date ?>">
                    ...
                    <div class="col-md-4">
                        <select name="service" id="service" class="form-control">
                            ...
                            ?>
                            <option value="<?= $data->service_type ?>" selected><?= $data->service_type ?></option>
                        </select>
                    ...
                    <div class="col-md-4">
                        <select name="timeslot" id="timeslot" class="form-control">
                            ...
                            ?>
                            <option value="<?= $data->timeslot ?>" selected><?= $data->timeslot ?></option>
