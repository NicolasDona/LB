    ...
    <div class="container p-4">
        <div class="row letter-sp">
            <div class="col-lg-6 col-md-12 mb-4">
                <h5 class="mb-3 font-title fw-bold">LB Coiffure</h5>
                <p class="regular">
            ...
            <!-- Partie Droite  -->
            <div class="col-lg-3 col-md-6 mb-4 regular">
                <h5 class="mb-3 font-title fw-bold">Heures d'ouvertures</h5>
                <p class="">mar - jeu : 9h- 19H</p>
                <p>ven - sam : 9h - 18H</p>
            </div>
        </div>
    </div>
...
<!-- JS PERSO -->
<script src="/lb/public/assets/js/script.js"></script>
<script src="/lb/public/assets/js/reg.js"></script>
</body>
